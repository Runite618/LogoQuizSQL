...
public class FXMLController implements Initializable {
   ...
   //Declare FXML variables from scene builder
   @FXML
   ...
   // The method for when we need to dynamically update and use the scene
   ...
   //Enables us to define a user and then pass it through scenes
